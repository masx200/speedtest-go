...
function Speedtest() {
  ...
  console.log(
    "LibreSpeed by Federico Dossena v5.2.4 - https://github.com/masx200/speedtest-go",
  );
}
...
Speedtest.prototype = {
  ...
  start: function () {
    ...
    if (this._state == 2) {
      this._settings.url_dl = this._selectedServer.server +
        this._selectedServer.dlURL;
      this._settings.url_ul = this._selectedServer.server +
        this._selectedServer.ulURL;
      this._settings.url_ping = this._selectedServer.server +
        this._selectedServer.pingURL;
      this._settings.url_getIp = this._selectedServer.server +
